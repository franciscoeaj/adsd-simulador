...
public class Lanchonete extends Sim_entity {
	...
	public Lanchonete(Entidades lanchonete, double media, double variancia) {
		super(lanchonete.getNome());
	...
	public void body() {
		while (Sim_system.running()) {
			...
			if (p <= 0.1) {
				sim_trace(1, "Pessoa sai da lanchonete e vai para as cadeiras");
				sim_schedule(arqCadeiras, 0.0, 1);
			} else {
				sim_trace(1, "Pessoa sai da lanchonete e vai para a torcida geral");
